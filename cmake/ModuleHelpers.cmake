...
Arguments:
  <name>        - Name of the module (without demo_ prefix)
...
This function creates:
  - demo_<name> target (INTERFACE if no SOURCES, regular library if SOURCES provided)
  - demo::<name> alias
...
function(add_demo_module MODULE_NAME)
  ...
  set(TARGET_NAME "demo_${MODULE_NAME}")
  ...
  if(ARG_SOURCES)
    ...
    add_library(demo::${MODULE_NAME} ALIAS ${TARGET_NAME})
