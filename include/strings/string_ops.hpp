...
enum class StringError { kEmpty, kInvalidFormat, kConversionError, kPatternNotFound };
...
class StringProcessor {
 public:
  ...
  static auto Replace(std::string_view input, std::string_view from, std::string_view to)
      -> std::string;

  static auto ReplaceAll(std::string_view input, std::string_view from, std::string_view to)
      -> std::string;
